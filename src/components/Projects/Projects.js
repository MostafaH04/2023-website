...
function Projects(props)
{
    ...
    if (props.hardware)
    {
        projectList = [
            ...
            {
                name: "Sound Vision",
                description: "Developed a project for the University of Waterloo Design for All program, focusing on aiding visually impaired individuals. Utilized an ultrasonic sensor and servo to provide auditory feedback for obstacle detection, showcasing skills in sensor integration, assistive technology, and hardware-software interaction.",
